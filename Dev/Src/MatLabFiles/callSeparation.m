...
for k = 1:length(wavFileStruct)
    try
        ...
        if ~isempty(peepCalls)
            ...
            audiowrite(strcat('../../../Data/SeperatedData/Training/peepCallsTrain',fileNum,'.wav'),AveragedHPFpeepCallsTrain,fs);
            audiowrite(strcat('../../../Data/SeperatedData/Testing/peepCallsTest',fileNum,'.wav'),AveragedHPFpeepCallsTest,fs);
        end
        ...
        if ~isempty(peepStringCalls)
            ...
            audiowrite(strcat('../../../Data/SeperatedData/Training/peepStringCallsTrain',fileNum,'.wav'),AveragedHPFpeepStringCallsTrain,fs);
            audiowrite(strcat('../../../Data/SeperatedData/Testing/peepStringCallsTest',fileNum,'.wav'),AveragedHPFpeepStringCallsTest,fs);
        end
        % twitter
        twitterCalls = [];
        ...
        if ~isempty(twitterCalls)
            ...
            audiowrite(strcat('../../../Data/SeperatedData/Training/twitterCallsTrain',fileNum,'.wav'),AveragedHPFtwitterCallsTrain,fs);
            audiowrite(strcat('../../../Data/SeperatedData/Testing/twitterCallsTest',fileNum,'.wav'),AveragedHPFtwitterCallsTest,fs);
        end
        % tsik
        tsikCalls = [];
        ...
        if ~isempty(tsikCalls)
            ...
            audiowrite(strcat('../../../Data/SeperatedData/Training/tsikCallsTrain',fileNum,'.wav'),AveragedHPFtsikCallsTrain,fs);
            audiowrite(strcat('../../../Data/SeperatedData/Testing/tsikCallsTest',fileNum,'.wav'),AveragedHPFtsikCallsTest,fs);
        end
        ...
        if ~isempty(pheeCalls)
            ...
            audiowrite(strcat('../../../Data/SeperatedData/Training/pheeCallsTrain',fileNum,'.wav'),AveragedHPFpheeCallsTrain,fs);
            audiowrite(strcat('../../../Data/SeperatedData/Testing/pheeCallsTest',fileNum,'.wav'),AveragedHPFpheeCallsTest,fs);
        end
        % combo
        comboCalls = [];
        ...
        if ~isempty(comboCalls)
            ...
            audiowrite(strcat('../../../Data/SeperatedData/Training/comboCallsTrain',fileNum,'.wav'),AveragedHPFcomboCallsTrain,fs);
            audiowrite(strcat('../../../Data/SeperatedData/Testing/comboCallsTest',fileNum,'.wav'),AveragedHPFcomboCallsTest,fs);
        end
        % trill
        trillCalls = [];
        ...
        if ~isempty(trillCalls)
            ...
            audiowrite(strcat('../../../Data/SeperatedData/Training/trillCallsTrain',fileNum,'.wav'),AveragedHPFtrillCallsTrain,fs);
            audiowrite(strcat('../../../Data/SeperatedData/Testing/trillCallsTest',fileNum,'.wav'),AveragedHPFtrillCallsTest,fs);
        end
        ...
        if ~isempty(noVoiceCalls)
            ...
            audiowrite(strcat('../../../Data/SeperatedData/Training/noVoiceCallsTrain',fileNum,'.wav'),AveragedHPFnoVoiceCallsTrain,fs);
            audiowrite(strcat('../../../Data/SeperatedData/Testing/noVoiceCallsTest',fileNum,'.wav'),AveragedHPFnoVoiceCallsTest,fs);
        end
    catch exception
        throw(exception)
    end
